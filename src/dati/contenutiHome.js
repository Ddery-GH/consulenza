export const navigazione = {
  ...
  voci: [
    { etichetta: "Metodo", ancora: "#metodo" },
    { etichetta: "Soluzioni", ancora: "#ambiti" },
    { etichetta: "Profilo", ancora: "#profilo" },
    { etichetta: "Percorso", ancora: "#percorso" },
...
export const footer = {
  ...
  colonne: [
    ...
    {
      titolo: "Informazioni",
      voci: ["Come funziona", "Ambiti di lavoro", "Domande frequenti"],
    },
    {
      titolo: "Contatti",
      voci: ["Richiedi un confronto", "Informazioni generali"],
    },
  ],
  copyright: `© ${new Date().getFullYear()} Enrico Di Prisco. Tutti i diritti riservati.`,
};
